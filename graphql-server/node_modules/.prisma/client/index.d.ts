...
export namespace Prisma {
  ...
  */
  ...
  export type TaskSelect = {
    ...
    children?: boolean | TaskFindManyArgs
    userId?: boolean
  ...
  export type TaskGetPayload<S extends boolean | null | undefined | TaskArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'children' ? Array < TaskGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'children' ? Array < TaskGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__TaskClient<T, Null = never> implements PrismaPromise<T> {
    ...
    children<T extends TaskFindManyArgs= {}>(args?: Subset<T, TaskFindManyArgs>): PrismaPromise<Array<TaskGetPayload<T>>| Null>;
  ...
  export type TaskUpdateManyWithWhereWithoutParentInput = {
    where: TaskScalarWhereInput
    data: XOR<TaskUpdateManyMutationInput, TaskUncheckedUpdateManyWithoutChildrenInput>
  }
  ...
  export type TaskUncheckedUpdateManyWithoutChildrenInput = {
    id?: IntFieldUpdateOperationsInput | number
    title?: StringFieldUpdateOperationsInput | string
    subtitle?: NullableStringFieldUpdateOperationsInput | string | null
    notes?: NullableStringFieldUpdateOperationsInput | string | null
